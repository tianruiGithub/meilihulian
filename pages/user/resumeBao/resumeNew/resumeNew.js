...
Page({
  ...
  */
  baocun: function () {
    console.log("保存")
    var that = this
    if (that.data.jianliname != '' && that.data.name != '' && that.data.birthday != '' && that.data.phone != '' && that.data.city != '' && that.data.headpic != '' && that.data.sname != '' && that.data.sstarttime != '' && that.data.sendtime != '' && that.data.slevel != '' && that.data.zyid != '' && that.data.cname != '' && that.data.cstarttime != '' && that.data.cendtime != '' && that.data.znid != '' && that.data.cjob_name != '' && that.data.cdescs != '') {
      console.log("发送成功")
      wx.request({
        url: app.globalData.https + "/x/Handler/Operate.ashx",
        data: ({
